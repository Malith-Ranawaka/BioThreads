...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    sizes: ['S', 'M', 'L', 'XL'],
    colors: [
      { name: 'Natural', hex: '#f5f5f4', image: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?q=80&w=800&auto=format&fit=crop' },
      { name: 'Sage', hex: '#84a59d', image: 'https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?q=80&w=800&auto=format&fit=crop' },
      { name: 'Stone', hex: '#78716c', image: 'https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?q=80&w=800&auto=format&fit=crop' }
    ]
  },
  {
    id: 'bio-2',
    ...
    sizes: ['S', 'M', 'L', 'XL'],
    colors: [
      { name: 'Off-White', hex: '#fafaf9', image: 'https://images.unsplash.com/photo-1618354691373-d851c5c3a990?q=80&w=800&auto=format&fit=crop' },
      { name: 'Charcoal', hex: '#44403c', image: 'https://images.unsplash.com/photo-1523381210434-271e8be1f52b?q=80&w=800&auto=format&fit=crop' }
    ]
  },
  {
    id: 'bio-3',
    ...
    sizes: ['M', 'L', 'XL'],
    colors: [
      { name: 'Olive', hex: '#4b5320', image: 'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?q=80&w=800&auto=format&fit=crop' },
      { name: 'Sand', hex: '#c2b280', image: 'https://images.unsplash.com/photo-1551028719-00167b16eac5?q=80&w=800&auto=format&fit=crop' }
    ]
  },
  {
    id: '1',
    ...
    secondaryImage: 'https://images.unsplash.com/photo-1598033129183-c4f50c7176c8?q=80&w=800&auto=format&fit=crop',
    ...
    sizes: ['S', 'M', 'L', 'XL'],
    colors: [
      { name: 'Sky', hex: '#bae6fd', image: 'https://images.unsplash.com/photo-1596755094514-f87e34085b2c?q=80&w=800&auto=format&fit=crop' },
      { name: 'White', hex: '#ffffff', image: 'https://images.unsplash.com/photo-1626497748470-284d81f9f350?q=80&w=800&auto=format&fit=crop' }
    ]
  },
  {
    id: '2',
    ...
    sizes: ['S', 'M', 'L', 'XL'],
    colors: [
      { name: 'Black', hex: '#000000', image: 'https://images.unsplash.com/photo-1523381210434-271e8be1f52b?q=80&w=800&auto=format&fit=crop' },
      { name: 'Grey', hex: '#71717a', image: 'https://images.unsplash.com/photo-1581655353564-df123a1eb820?q=80&w=800&auto=format&fit=crop' }
    ]
  },
  {
    id: '3',
    ...
    sizes: ['30', '32', '34', '36'],
    colors: [
      { name: 'Khaki', hex: '#c3b091', image: 'https://images.unsplash.com/photo-1473966968600-fa801b869a1a?q=80&w=800&auto=format&fit=crop' },
      { name: 'Navy', hex: '#000080', image: 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?q=80&w=800&auto=format&fit=crop' }
    ]
  },
  {
    id: '4',
    ...
    sizes: ['S', 'M', 'L', 'XL'],
    colors: [
      { name: 'Cloud', hex: '#f8fafc', image: 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?q=80&w=800&auto=format&fit=crop' },
      { name: 'Storm', hex: '#475569', image: 'https://images.unsplash.com/photo-1513273195090-c742527369a0?q=80&w=800&auto=format&fit=crop' }
    ]
  },
  {
    id: '5',
    ...
    sizes: ['M', 'L'],
    colors: [
      { name: 'Forest', hex: '#228b22', image: 'https://images.unsplash.com/photo-1539533018447-63fcce2678e3?q=80&w=800&auto=format&fit=crop' },
      { name: 'Midnight', hex: '#191970', image: 'https://images.unsplash.com/photo-1548883354-7622d03aca27?q=80&w=800&auto=format&fit=crop' }
    ]
  }
];
...
export const HERO_SLIDES = [
  ...
  },
  {
    ...
    subtitle: 'Up to 40% off on our sustainable collection.',
